...
public final class CustomFriendListBinding implements ViewBinding {
  ...
  @NonNull
  public static CustomFriendListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CustomFriendListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.custom_friend_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CustomFriendListBinding bind(@NonNull View rootView) {
