...
public class SelectLocation extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.map_view_in_scroll, null);
        ...
        // Setup the map view
        map = view.findViewById(R.id.mapscroll);
    ...
    private IconOverlay newMark(GeoPoint selection) {
        ...
        Drawable icon = getContext().getResources().getDrawable(R.drawable.ic_baseline_habit_location, theme);
